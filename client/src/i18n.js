const translations = {
  fr: {
    ...
    pronosRemaining: 'restant(s) à poser',
    pronosSeeAll: 'Voir tout',
    pronosAllDone: 'Tout est posé !',
    ...
    secureAccount: 'Ajouter un email et mot de passe',
    secureAccountSubtitle: 'Pour ne pas perdre ton compte si tu changes d\'appareil',
    secureAccountHint: 'Tu pourras te reconnecter depuis n\'importe quel appareil.',
    accountSecured: 'Compte sécurisé !',
    emailNotVerified: 'Email non confirmé',
    emailNotVerifiedHint: 'Vérifie ta boîte mail et clique sur le lien pour confirmer ton adresse.',
    emailVerified: 'Email confirmé',
    resendVerification: 'Renvoyer le lien',
    verificationSent: 'Email envoyé !',
    verificationAlready: 'Déjà confirmé !',
    logout: 'Déconnexion',
    or: 'ou',
    continueWithoutAccount: 'Continuer sans compte',
    continueWithoutAccountHint: 'Ton compte sera lié à cet appareil. Tu pourras ajouter un email plus tard.',
    ...
    welcomeToast: 'Bienvenue ! Pose tes pronos avant le coup d\'envoi.',
  ...
  en: {
    ...
    pronosRemaining: 'left to predict',
    pronosSeeAll: 'See all',
    pronosAllDone: 'All set!',
    ...
    secureAccount: 'Add an email and password',
    secureAccountSubtitle: 'So you don\'t lose your account if you switch devices',
    secureAccountHint: 'You\'ll be able to log in from any device.',
    accountSecured: 'Account secured!',
    emailNotVerified: 'Email not confirmed',
    emailNotVerifiedHint: 'Check your inbox and click the link to confirm your email address.',
    emailVerified: 'Email confirmed',
    resendVerification: 'Resend link',
    verificationSent: 'Email sent!',
    verificationAlready: 'Already confirmed!',
    logout: 'Log out',
    or: 'or',
    continueWithoutAccount: 'Continue without account',
    continueWithoutAccountHint: 'Your account will be tied to this device. You can add an email later.',
    ...
    welcomeToast: 'Welcome! Place your predictions before kickoff.',
